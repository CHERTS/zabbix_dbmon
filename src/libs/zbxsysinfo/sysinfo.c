...
/******************************************************************************
 *                                                                            *
 * Function: zbx_execute_dbmon_threaded_metric                                      *
 *                                                                            *
 ...
 *                                                                            *
 ******************************************************************************/
int	zbx_execute_dbmon_threaded_metric(zbx_metric_func_t metric_func, AGENT_REQUEST *request, AGENT_RESULT *result)
{
	...
	zbx_alarm_on(CONFIG_DB_TIMEOUT);
...
int	zbx_execute_dbmon_threaded_metric(zbx_metric_func_t metric_func, AGENT_REQUEST *request, AGENT_RESULT *result)
{
	...
	if (WAIT_FAILED == (rc = WaitForSingleObject(thread, CONFIG_DB_TIMEOUT * 1000)))
	{
		/* unexpected error */
